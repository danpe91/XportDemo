<powershell>
 ...
 $env:CHEF_SERVER_NAME = "Chef-Demo" # Name of your Chef Server
 $env:CHEF_SERVER_ENDPOINT = "chef-demo-8i5tcwbjgonhbvuc.us-west-1.opsworks-cm.io" # FQDN of your Chef Server
 $env:REGION = "us-west-1" # Region of your Chef Server (choose one of our supported regions - us-east-1, us-east-2, us-west-1, us-west-2, eu-central-1, eu-west-1, ap-northeast-1, ap-southeast-1, ap-southeast-2)
